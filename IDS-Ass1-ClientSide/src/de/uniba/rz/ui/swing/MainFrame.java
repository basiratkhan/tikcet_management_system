...
public class MainFrame extends JFrame implements Observer {
	...
	try {
	    ...
	    showErrorDialog(
		    "Unable to create UI as there were problems connecting to the backend! Shutting down system...",
		    e);
	...
	panel.add(createTicketTablePanel(), BorderLayout.NORTH);
	...
	saveButton.addActionListener(new ActionListener() {
	    ...
	    @Override
	    public void actionPerformed(ActionEvent e) {
		controller.createNewTicket(repField.getText(),
			topicField.getText(), descArea.getText(),
			(de.uniba.rz.entities.Type) typeBox.getSelectedItem(),
			(Priority) prioBox.getSelectedItem());
	    }
	});
	...
	JOptionPane.showMessageDialog(this, scrollPane, msg,
	...
	pane.add(new JLabel("Tickets currently available:"),
		BorderLayout.NORTH);
	...
	listSelect.addListSelectionListener(new ListSelectionListener() {
		...
		if (!arg0.getValueIsAdjusting()
		    ...
		    controller.getAndShowTicketById((Integer) table
	...
	private String[] columns = { "Status", "#", "Topic", "Reporter", "Prio",
		"Type" };
